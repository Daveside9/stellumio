# Stellumio — OSS Week Contributor Board
...
4. Stuck? Post in [Discussions → OSS Week](https://github.com/Ezedike-Evan/stellumio/discussions).
...
| 23  | `issue.md#161` | MCP tool: `stellumio.price_offramp`                        | `packages/mcp/*`                     |
...
- Filter issues by [`good-first-issue`](https://github.com/Ezedike-Evan/stellumio/labels/good-first-issue).
