...
[![License: MIT](https://img.shields.io/github/license/Ezedike-Evan/stellumio?style=flat-square)](LICENSE)
[![CI](https://img.shields.io/github/actions/workflow/status/Ezedike-Evan/stellumio/ci.yml?branch=main&style=flat-square&label=ci)](https://github.com/Ezedike-Evan/stellumio/actions/workflows/ci.yml)
[![Coverage](https://img.shields.io/codecov/c/github/Ezedike-Evan/stellumio?style=flat-square)](https://codecov.io/gh/Ezedike-Evan/stellumio)
[![npm (@stellumio/sdk)](https://img.shields.io/npm/v/@stellumio/sdk?style=flat-square&label=%40stellumio%2Fsdk)](https://www.npmjs.com/package/@stellumio/sdk)
[![Deployed on Vercel](https://img.shields.io/badge/deploy-vercel-000?style=flat-square&logo=vercel)](https://stellumio.vercel.app)
...
Stellumio is a rate aggregator for the Stellar ecosystem. It compares
...
<p align="center">
  <a href="https://stellumio.vercel.app">
    <img src="docs/images/hero.png" alt="Stellumio off-ramp comparison — live anchor quotes, fee breakdown, and one-click execution" width="860" />
  </a>
  <br />
  <em>Live demo → <a href="https://stellumio.vercel.app">stellumio.vercel.app</a></em>
</p>
...
Stellumio is the **execution layer for stablecoin value on Stellar**. We
...
git clone https://github.com/your-org/stellumio.git
cd stellumio
...
- Issues tagged [`good-first-issue`](https://github.com/Ezedike-Evan/stellumio/labels/good-first-issue) — scoped, unblocked, reviewer-ready.
- Issues tagged [`help-wanted`](https://github.com/Ezedike-Evan/stellumio/labels/help-wanted) — larger tickets actively looking for owners.
...
<table>
  <tr>
    ...
    <td align="center" width="140">
      <a href="https://github.com/Ezedike-Evan/stellumio/blob/main/CONTRIBUTING.md">
