# Stellumio — Grant Proposal (Resubmission)
...
| **Repository**        | [github.com/Ezedike-Evan/stellumio](https://github.com/Ezedike-Evan/stellumio)                     |
| **Live demo**         | [stellumio.vercel.app](https://stellumio.vercel.app)                                               |
| **License**           | MIT                                                                                                        |
...
Stellumio is that layer. It is a single product that does four things the
...
- The seven corridors Stellumio ships today (NGN, KES, GHS, MXN, BRL, ARS,
...
The intent is the unit of work Stellumio routes. It is canonicalized,
...
The MCP surface is the wedge that makes Stellumio the default execution
...
| **v4 Universal**                 | MCP agent surface GA + SDK                     | `@stellumio/sdk` on npm, `@stellumio/mcp` on npm, embeddable widget                     | 240 days           |
...
- **Why Stellar, not a bridge.** The SEPs are the whole story. No other chain
  has an on-ramp/off-ramp specification of this rigour. Stellumio is a
